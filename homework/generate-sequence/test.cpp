...
TEST_P(GenerateSequenceTestFixture, ShouldCreateVector) {
  ...
  EXPECT_EQ(generateSequence(test_data.count, test_data.step),
            test_data.expected_result);
}

INSTANTIATE_TEST_SUITE_P(
    GenerateSequenceTests, GenerateSequenceTestFixture,
    ::testing::Values(
        Params{0, 0, std::vector<int>{}}, Params{-3, 0, std::vector<int>{}},
        Params{-3, 3, std::vector<int>{}}, Params{1, 0, std::vector<int>{0}},
        ...
        Params{10, 5,
               std::vector<int>{5, 10, 15, 20, 25, 30, 35, 40, 45, 50}}));
