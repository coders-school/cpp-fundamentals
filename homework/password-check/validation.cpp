...
{
    if(oneNumber(password) != true)         return ErrorCode::PasswordNeedsAtLeastOneNumber;
    if(specialCharacter(password) != true)  return ErrorCode::PasswordNeedsAtLeastOneSpecialCharacter;
    if(uppercaseLetter(password) != true)   return ErrorCode::PasswordNeedsAtLeastOneUppercaseLetter;
    if(nineCharacter(password) == true)     return ErrorCode::PasswordNeedsAtLeastNineCharacters;
    if(okPassword(password) == true)        return ErrorCode::Ok;
}
